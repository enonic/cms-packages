                ...
                $(function() {
                    ...
                    $('#share-bar-tip-dialog').dialog({
                        ...
                        <xsl:choose>
                            <xsl:when test="$fw:device-class = 'mobile'">
                                <xsl:value-of select="concat('width: ', $fw:region-width, ',')"/>
                    ...
                    $('#tip-form').validate({
                        ...
                        submitHandler: function (form) {
                            <xsl:value-of select="concat('$(&quot;#tip-tip&quot;).val(&quot;\n', portal:localize('Hi'), '!\n\n&quot; + $(&quot;#tip-from-name&quot;).val() + &quot; ', portal:localize('tip-mail-text', ($fw:site-name, util:menuitem-name(/result/context/resource), $current-url)), '\n\n&quot; + $(&quot;#tip-from-name&quot;).val() + &quot; ', portal:localize('writes'), ':\n\n&quot; + $(&quot;#tip-message&quot;).val());')"/>
        ...
        <div id="share-bar-tip-dialog" title="{portal:localize('Tip-a-friend')}">
            <form action="{portal:createServicesUrl('sendmail', 'send')}" method="post" id="tip-form" class="dont-validate">
                <fieldset>
                    ...
                    <input name="subject" type="hidden" value="{portal:localize('tip-mail-subject', ($fw:site-name))}"/>
